...
def main() -> None:
    ...
    for row in rows:
        records.append({
            ...
            "listed_address": row.get("listed_address", ""),
            "listed_phone": row.get("listed_phone", ""),
            "listed_website": row.get("listed_website", ""),
            "source_listed_website": row.get("source_listed_website", ""),
            "source_listed_website_status": row.get("source_listed_website_status", ""),
