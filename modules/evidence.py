            ...
            for row in rows:
                ...
                record = {
                    ...
                    "publication_decision": {
                        ...
                        "field_gaps": row.get("publication_field_gaps", ""),
                        "missing_evidence": (row.get("content_decision") or {}).get("missing_evidence", []) if isinstance(row.get("content_decision"), dict) else [],
                        "reason_codes": (row.get("content_decision") or {}).get("reason_codes", []) if isinstance(row.get("content_decision"), dict) else [],
